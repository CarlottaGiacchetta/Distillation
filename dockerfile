...
#CONCATMEAN 
#CMD ["python", "main_unic.py", "--batch_size", "32", "--data_dir", "data1/ssl4eo_s12", "--dataset", "ssl4eo", "--arch", "vit_large", "--saveckpt_freq", "5", "--in_chans", "9", "--output_dir", "ScalemaeDistill9/Vit_Large/ConcatMeanSS_giusto", "--teachers", "scalemae_rgb,scalemae_veg,scalemae_geo", "--Teacher_strategy", "[\"mean\"]", "--transform", "False", "--num_frames", "1", "--imagenet_pretrained", "False", "--patch_size", "16"]
...
#FINETUNING student
#CMD ["python", "run_finetuning.py", "--batch_size", "128", "--data_dir", "dati", "--checkpoint_path", "ScalemaeDistill9/Vit_Tiny/ConcatMeanSS_giusto/checkpoint_0045.pth", "--checkpoint_dir", "ScalemaeDistill9/Vit_Tiny/ConcatMeanSS_giusto/FREEZE_BACKBONE/", "--output_dir", "ScalemaeDistill9/Vit_Tiny/ConcatMeanSS_giusto/FREEZE_BACKBONE/", "--model", "vit", "--arch", "vit_tiny", "--finetune_backbone", "False", "--in_chans", "9", "--lr", "1e-4", "--patience", "4", "--epochs", "100", "--fintuning_bands", "nove", "--patch_size", "16", "--transform", "False"]



#TEST
CMD ["python", "test_finetuning.py", "--batch_size", "128", "--data_dir", "dati", "--checkpoint_path", "/raid/home/rsde/cgiacchetta_unic/Distillation/ScalemaeDistill9/Vit_Tiny/ConcatMeanSS_giusto/NOT_FREEZE_BACKBONE/best-checkpoint.ckpt", "--output_dir", "/raid/home/rsde/cgiacchetta_unic/Distillation/ScalemaeDistill9/Vit_Tiny/ConcatMeanSS_giusto/NOT_FREEZE_BACKBONE/", "--model", "vit", "--arch", "vit_tiny", "--in_chans", "9", "--finetuning_bands", "nove"]
